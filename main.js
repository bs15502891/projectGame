...
function knightAttack() {
  let heroAttack =
    (heroAttributes.heroSTR * 10 +
      heroAttributes.heroDEX * 3 +
      heroAttributes.heroINT * 0 +
      heroAttributes.heroVIT * 0 +
      heroEquips.heroWEAPON * 10) /
    10;
  return heroAttack;
}
...
function assassinAttack() {
  let heroAttack =
    (heroAttributes.heroSTR * 7 +
      heroAttributes.heroDEX * 10 +
      heroAttributes.heroINT * 0 +
      heroAttributes.heroVIT * 0 +
      heroEquips.heroWEAPON * 10) /
    10;
...
function mageAttack() {
  let heroAttack =
    (heroAttributes.heroSTR * 0 +
      heroAttributes.heroDEX * 0 +
      heroAttributes.heroINT * 20 +
      heroAttributes.heroVIT * 0 +
      heroEquips.heroWEAPON * 10) /
    10;
  return heroAttack;
...
function monster1() {
  let monsterDamage = Math.round(
    monsterDamageBase[1] - heroDefense[`${heroStatus.heroClass}`]()
  );
...
function monster2() {
  let monsterDamage = Math.round(
    monsterDamageBase[2] - heroDefense[`${heroStatus.heroClass}`]()
  );
  return monsterDamage;
}
...
function monster3() {
  let monsterDamage = Math.round(
    monsterDamageBase[3] - heroDefense[`${heroStatus.heroClass}`]()
  );
  return monsterDamage;
}
...
function monster4() {
  let monsterDamage = Math.round(
    monsterDamageBase[4] - heroDefense[`${heroStatus.heroClass}`]()
  );
  return monsterDamage;
}
...
function monster5() {
  let monsterDamage = Math.round(
    monsterDamageBase[5] - heroDefense[`${heroStatus.heroClass}`]()
  );
  return monsterDamage;
}
...
function monster6() {
  let monsterDamage = Math.round(
    monsterDamageBase[6] - heroDefense[`${heroStatus.heroClass}`]()
  );
  return monsterDamage;
}
...
function monster7() {
  let monsterDamage = Math.round(
    monsterDamageBase[7] - heroDefense[`${heroStatus.heroClass}`]()
  );
  return monsterDamage;
}
...
function monster8() {
  let monsterDamage = Math.round(
    monsterDamageBase[8] - heroDefense[`${heroStatus.heroClass}`]()
  );
  return monsterDamage;
}
...
const attributesPrice7 = document.querySelector(
  '#MobilePage7 .attributesPrice'
);
